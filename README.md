...
> Instant image lightbox viewer

[![npm version](https://badge.fury.io/js/instant-lightbox-js.svg)](https://www.npmjs.com/package/instant-lightbox-js)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install instant-lightbox-js
```

## Quick Start

```javascript
const { js } = require('instant-lightbox-js');
...
```javascript
const { js, batch } = require('instant-lightbox-js');
